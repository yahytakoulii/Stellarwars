...
prog: main.o source.o joueur.o highscore.o minimap.o puzzle_game/puzzle
	$(CC) main.o source.o joueur.o highscore.o minimap.o -o prog $(LIBS)

main.o: main.c header.h highscore.h minimap/minimap.h
	$(CC) -c main.c $(CFLAGS)
...
clean:
	rm -f prog main.o source.o joueur.o highscore.o minimap.o
